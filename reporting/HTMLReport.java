...
public class HTMLReport {
	 ...
	 */
	 ...
	 public void makeHtmlReport( LinkedHashMap<String, ArrayList<String>> resultSet, ArrayList<String> executableFiles){ 
	 ...
	 /**
		 ...
		 */
		 ...
		 public void makeGridHtmlReport( LinkedHashMap<String, ArrayList<String>> resultSet, ArrayList<String> executableFiles){ 
		  ...
		  for (String fileName : executableFiles) {
			  ...
			  try { 	  
				  out.write("	<html>\n"
					  ...
					  + " 							color: white;'> OS </th>\n" +
					  " 						<th style='width:5%; border: solid 1px black; background-color: Crimson;"
					  + " 							color: white;'> BROWSER </th>\n" +
					  " 						<th style='width:5%; border: solid 1px black; background-color: Crimson;"
					  + " 							color: white;'> STATUS </th>\n" +
					  "							<th style=' width:45%; border: solid 1px black; background-color: Crimson;"
					  + "							color: white;'> ERROR MESSAGE </th>\n" +
					  "							<th style='width:20%; border: solid 1px black; background-color: Crimson;"
					  + "							color: white;'> SCREENSHOT NAME </th>\n" + "						"
					  + "                  </tr>\n" 
			  ...
			  for (String keys : resultSet.keySet()){
				  ...
				  if (keys.split("::")[0].equals(fileName)){
					  ...
					  String sheetName =keys.split("::")[1];
					  String OS= keys.split("::")[2];
					  String browser = keys.split("::")[4];
					  
					  try { 
						  
						  out.write( "<td style='color:black; border: solid 1px black; align:center;'> "+ sheetName + "</td>\n");
						  out.write( "<td style='color:black; border: solid 1px black; align:center;'> "+ OS + "</td>\n");
						  out.write( "<td style='color:black; border: solid 1px black; align:center;'> "+ browser + "</td>\n");
